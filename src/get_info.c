...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/05/19 18:37:19 by akabbouc          #+#    #+#             */
/*   Updated: 2017/05/25 23:58:03 by akabbouc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			get_data(char *player, t_obj *e)
{
	...
	while (get_next_line(0, &line) > 0)
	{
		...
		else if (line && ft_strncmp(line, "Plateau", 2) == 0)
		{
			recup_arena(line, e);
			ft_putchar_fd('\n', 2);
		}
		else if (line && ft_strncmp(line, "Piece", 2) == 0)
		{
			recup_piece(line, e);
			free(line);
			return (1);
